...
class Fish:
    ...
    def take_damage(self, amount: int, source: Optional[Fish], *, direct: bool = True,
                    game: Optional["GameState"] = None) -> int:
    ...
    # ------------------------------------------------------------------
    def after_direct_damage(self, amount: int, source: Optional[Fish], game: "GameState") -> None:
        """Called after damage is successfully applied by a direct attack."""
        pass

    def after_teammate_attacked(self, mate: Fish, source: Fish, game: "GameState") -> None:
        """Called after a teammate was attacked."""
        pass

    def after_direct_attack(self, target: Fish, game: "GameState", *, used_normal: bool) -> None:
    ...
    # Actions
    # ------------------------------------------------------------------
    def normal_attack(self, target: Fish, game: "GameState") -> None:
    ...
    def active(self, game: "GameState", actor_idx: int) -> None:
...
class MimicFish(Fish):
    def copy_from(self, template: Fish) -> None:
        ...
        self.active = template.active  # type: ignore
        self.after_direct_damage = template.after_direct_damage  # type: ignore
        self.after_teammate_attacked = template.after_teammate_attacked  # type: ignore
        self.after_direct_attack = template.after_direct_attack  # type: ignore
        self.take_damage = template.take_damage  # type: ignore

    def active(self, game: "GameState", actor_idx: int) -> None:  # pragma: no cover - replaced
        pass
